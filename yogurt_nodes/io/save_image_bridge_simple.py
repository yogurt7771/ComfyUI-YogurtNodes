...
class SaveImageBridgeSimpleNonOutput(SaveImageBridgeSimple):
    """Save Image Bridge Simple (Non Output) node."""
    OUTPUT_NODE = False
    _NODE_NAME = "Save Image Bridge Simple (Non Output)"
